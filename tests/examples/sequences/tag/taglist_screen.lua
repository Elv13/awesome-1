...
awful.tag({ "s1_t1", "s1_t2", "s1_t3" }, screen[1], awful.layout.suit.corner.nw)
awful.tag({ "s2_t1", "s2_t2", "s3_t3" }, screen[2], awful.layout.suit.tile.left)
...
module.add_event("Change the taglist screen.", function()
    --DOC_HIDE_END
    -- Change the tastlist screen.
    taglist.screen = screen[2]
    --DOC_NEWLINE
    --DOC_HIDE_START
end)
